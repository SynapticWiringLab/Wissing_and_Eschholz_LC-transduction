% This script plots the efficacy of transgene expression using different promoters (hSyn vs CAG) for cre-dependent LC targetting in DBH-cre mice
% as reported in Wissing and Eschholz et al, PLOS Biology, 2025, Figure 3, panel C. 
...
xlim([0.5 2.5]); ylim([0 100]); ylabel('efficacy [%]')
