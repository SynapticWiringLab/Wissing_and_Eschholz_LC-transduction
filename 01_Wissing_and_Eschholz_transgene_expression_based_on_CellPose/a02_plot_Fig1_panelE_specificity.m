% This script plots the specificity of transgene expression using different model systems for LC targetting 
% as reported in Wissing and Eschholz et al, PLOS Biology, 2025, Figure 1, panel E. 
...
xlim([0.5 4.5]); ylim([0 100]); ylabel('specificity [%]')
